...
public class Question extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.execSQL("CREATE TABLE A3 (itemID int, Item text, Bins, text)");
        ...
        db.execSQL("insert into GreenCompass values('112','lenoir fork', 'recycle')");
        db.execSQL("insert into GreenCompass values('113','lenoir spoon', 'recycle')");
        db.execSQL("insert into GreenCompass values('114','lenoir knife', 'recycle')");
        db.execSQL("insert into GreenCompass values('115','rams fork', 'recycle')");
        db.execSQL("insert into GreenCompass values('116','rams spoon', 'recycle')");
        db.execSQL("insert into GreenCompass values('117','rams knife', 'recycle')");
        db.execSQL("insert into GreenCompass values('118','index cards', 'recycle')");
